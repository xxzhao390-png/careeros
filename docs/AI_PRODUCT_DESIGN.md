...
| P0 | 随手记智能分类与整理 | 想法先记下来，稍后自动归档 | AI MVP |
...
用户记录后先立即保存，再后台整理，不能让 AI 响应时间阻塞记录。AI 可输出：建议标题、摘要、类型、标签、所属模块、待办事项、截止时间（仅原文明确时）、相关知识/JD，以及是否需要用户处理。
